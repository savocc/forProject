...
if($lang == "Russian") {
    $input = array(
        ...
        "helper1"=>"Введите номер телефона без кода страны.",
        "helper2"=>"Фотография отразится в вашем профиле.",
    );
}
else{
    $input = array(
        ...
        "helper1"=>"Input number without a country code.",
        "helper2"=>"Photo will be displayed in your profile.",
    );
}
?>
<!doctype html>
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <div class="input-group-icon">
                                    <input class="input--style-4 js-datepicker" type="date" name="birthday" required></div>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                    ...
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label" title="<?php echo $input["helper1"] ;?>"><?php echo $input["phonen"] ;?></label>
                                <input class="input--style-4" type="text" name="phone" id ="phone" placeholder="1234567890"  onchange="phoneValid(this)" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required>
                            </div>
                        </div>
                    </div>
                    <div class="input-group">
                        <label class="label"title="<?php echo $input["helper2"] ;?>"><?php echo $input["upload"] ;?></label>
                    ...
                    <div class="p-t-15">
                        ...
                        <button class="btn btn--radius-2 btn--blue"  name = "submitbutton"  type="submit"><?php echo $input["submit"] ;?></button>
...
# переменная valid отвечает за открытие следующей страницы. Если значение - 1 - данные верны и при нажатии кнопки страница профайла  откроется
$valid = 1;
?>
<?php
     } else {
